...
class DocumentState(object):
  ...
  def finalize(self):
    ...
    all_mentions = list(set(util.flatten(merged_clusters)))
...
if __name__ == "__main__":
  ...
  print(vocab_file, input_dir, output_dir)
  print(do_lower_case)
  ...
  if not os.path.isdir(output_dir):
    os.mkdir(output_dir)
  for seg_len in [128]:
    minimize_language("bengali", labels, stats, vocab_file, seg_len, input_dir, output_dir, do_lower_case)
